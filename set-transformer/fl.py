...
# Define filenames for loading sets and ranks
sets_filename = "sets.pkl"
ranks_filename = "ranks.pkl"

# Load sets and ranks from disk
with open(sets_filename, 'rb') as f:
    sets = pickle.load(f)

with open(ranks_filename, 'rb') as f:
    subset_indices_dict = pickle.load(f)
    #print(len(subset_indices_dict))
